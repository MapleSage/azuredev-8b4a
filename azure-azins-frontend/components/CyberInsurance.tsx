...
export default function CyberInsurance() {
  ...
  const regions = [
    ...
    'australiaeast', 'japaneast', 'canadacentral'
  ]

  const handleShareFindings = () => {
    if (!accountId.trim()) {
      alert('Please enter your Azure Subscription ID.')
      return
    }
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-red-100 text-sm">Azure Security Center Based Risk Assessment</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div>
              <p className="text-gray-700 mb-4">
                Welcome to the SageInsure Cyber Insurance Portal. Share your <strong>Azure Security Center</strong> findings to receive a cyber insurance quote based on your security posture.
              </p>
              
              <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
                <h3 className="font-semibold text-blue-800 mb-2">Prerequisites:</h3>
                <ul className="text-blue-700 text-sm space-y-1">
                  <li>• Azure Security Center enabled across your organization</li>
                  <li>• Azure Security Benchmark standard enabled</li>
                  <li>• Security Center findings aggregated in a central subscription</li>
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  1. Share Security Center Findings with SageInsure
                </button>
