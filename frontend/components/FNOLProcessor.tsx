      ...
      <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white p-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-green-100">Intelligent First Notice of Loss document classification</p>
          </div>
        </div>
      </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
            ...
            <div className="bg-green-50 p-3 rounded-lg text-center">
              ...
              <p className="text-xs text-gray-600">Textract OCR</p>
            </div>
            <div className="bg-purple-50 p-3 rounded-lg text-center">
              <div className="text-xl mb-1">🤖</div>
              <h4 className="font-medium text-sm">Classify</h4>
              <p className="text-xs text-gray-600">Bedrock AI</p>
            </div>
            ...
            <div className="bg-indigo-50 p-3 rounded-lg text-center">
              ...
              <p className="text-xs text-gray-600">DynamoDB</p>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg text-center">
              <div className="text-xl mb-1">📦</div>
              <h4 className="font-medium text-sm">Archive</h4>
              <p className="text-xs text-gray-600">S3 Storage</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <div className="text-blue-700 space-y-2 text-sm">
              <p>• <strong>Step Functions:</strong> Orchestrates the entire processing workflow</p>
              <p>• <strong>S3 Buckets:</strong> Staging → In-Process → Text → Archive</p>
              <p>• <strong>Lambda Functions:</strong> 6 specialized processing functions</p>
              <p>• <strong>DynamoDB:</strong> Stores extracted claim data and metadata</p>
              <p>• <strong>EventBridge:</strong> Scheduled processing (Mon-Fri 5PM EST)</p>
            </div>
          </div>
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            ...
            <div className="text-green-700 space-y-2 text-sm">
              <p>• <strong>Document Upload:</strong> PDFs uploaded to scanning-staging bucket</p>
              <p>• <strong>Text Extraction:</strong> Textract processes documents asynchronously</p>
              <p>• <strong>AI Classification:</strong> Bedrock determines document type</p>
